...
public class CompeticionImpl extends Evento implements Competicion {
	...
	public CompeticionImpl() {
		super();
		this.mejoras = new ArrayList<String>();
	}

	public CompeticionImpl(String nombre, Instant fechaEvento, String lugar, String ciudad, String horaEvento,
